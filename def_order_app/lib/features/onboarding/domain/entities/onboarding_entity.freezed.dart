...
mixin _$OnboardingStepEntity {
  ...
  String? get customWidget => throw _privateConstructorUsedError;
  ...
  $OnboardingStepEntityCopyWith<OnboardingStepEntity> get copyWith =>
...
class _$OnboardingStepEntityImpl implements _OnboardingStepEntity {
  ...
  @override
  String toString() {
    return 'OnboardingStepEntity(id: $id, title: $title, description: $description, targetKey: $targetKey, type: $type, order: $order, customWidget: $customWidget, actionText: $actionText, isSkippable: $isSkippable, displayDuration: $displayDuration)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$OnboardingStepEntityImpl &&
...
/// @nodoc
mixin _$OnboardingProgressEntity {
  ...
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $OnboardingProgressEntityCopyWith<OnboardingProgressEntity> get copyWith =>
      throw _privateConstructorUsedError;
}
...
class _$OnboardingProgressEntityImpl extends _OnboardingProgressEntity {
  ...
  @override
  String toString() {
    return 'OnboardingProgressEntity(screenId: $screenId, isCompleted: $isCompleted, lastCompletedAt: $lastCompletedAt, completedSteps: $completedSteps, currentStep: $currentStep, totalSteps: $totalSteps)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$OnboardingProgressEntityImpl &&
