...
abstract class _OrderEntity extends OrderEntity {
  const factory _OrderEntity(
      ...
      final UserProfile? userProfile,
      final DeliveryAddress? deliveryAddress}) = _$OrderEntityImpl;
...
class _$UserProfileImpl extends _UserProfile {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, businessNumber, businessName,
      representativeName, phone, email, grade, status);
...
abstract class _UserProfile extends UserProfile {
  const factory _UserProfile(
      ...
      required final String status}) = _$UserProfileImpl;
...
class _$DeliveryAddressImpl implements _DeliveryAddress {
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, address, addressDetail, postalCode, phone);
...
abstract class _DeliveryAddress implements DeliveryAddress {
  const factory _DeliveryAddress(
      ...
      required final String phone}) = _$DeliveryAddressImpl;
...
class _$ValidationResultImpl extends _ValidationResult {
  const _$ValidationResultImpl(
      {required this.isValid, required final Map<String, String> errors})
      : _errors = errors,
        super._();
...
abstract class _ValidationResult extends ValidationResult {
  const factory _ValidationResult(
      ...
      required final Map<String, String> errors}) = _$ValidationResultImpl;
